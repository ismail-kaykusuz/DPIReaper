...
const SettingsConnectionTab = ({
  ...
  >
    ...
    <ConnectionProfilePicker config={config} updateConfig={updateConfig} t={t} />
    ...
    <div className="v2-section">
      ...
      <div className="v2-card">
          ...
          <Toggle
            ...
            onChange={(v) => {
              if (v) {
                ...
                updateConfig('selectedDns', 'cloudflare');
              }
            }}
          />
        </div>
        ...
        <div style={{
          ...
          pointerEvents: config.selectedDns === 'system' ? 'none' : 'auto',
