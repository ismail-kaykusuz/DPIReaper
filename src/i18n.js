const translations = {
  tr: {
    ...
    logStrongNoDriver: '⚠️ Güçlü Mod: Sürücü yok, seçilen chunk boyutu kullanılıyor.',
    logStrongChunkOnly: '🛡️ Güçlü Mod: Chunk parçalama aktif.',
    logLowCpuMode: '🟢 Düşük CPU modu: Fake paket kapalı, chunk ≥8 bayt.',
    ...
    lowCpuModeTitle: 'Düşük CPU (Defender uyumlu)',
    lowCpuModeDesc: 'Windows Defender ağ denetimi mini paketleri tek tek tarar. Chunk ≥8 ve fake paket kapalı — CPU düşer; çok agresif ISS\'lerde bypass zayıflayabilir.',
    defenderExclusionBtn: 'Defender istisnası ekle',
    defenderExclusionOk: 'Defender istisnaları eklendi. Tarayıcıyı yeniden deneyin.',
    defenderExclusionFail: 'İstisna eklenemedi. Uygulamayı yönetici olarak çalıştırın veya Windows Güvenliği → Virüs ve tehdit koruması → İstisnalar.',
    defenderExclusionNeedAdmin: 'Yönetici izni gerekli.',
    ...
    noticeDesc: 'Windows Defender “Ağ Denetimi” (MpDefenderCoreService) HTTPS trafiğini parça parça tarar; 1 baytlık chunk modunda CPU %90+ olabilir. Çözüm: Ayarlar → Düşük CPU modunu açın, chunk 8+ seçin veya Defender istisnası ekleyin. Yanlış pozitif uyarıları zararsızdır; Kaspersky/ESET HTTPS taraması da benzer yük oluşturabilir.',
    ...
    sectionAdvancedBypass: 'GELİŞMİŞ BYPASS',
    advancedHint: 'Bu ayarlar uzman kullanıcılar içindir. Varsayılan değerler çoğu durumda yeterlidir.',
    profileFastName: 'Hızlı',
    profileFastDesc: 'En hafif bypass, en yüksek hız.',
    profileFastIsps: 'Yumuşak DPI: Türknet, küçük yerel ISP\'ler',
    profileRecommendedName: 'Önerilen',
    profileRecommendedDesc: 'Çoğu kullanıcı için en uygun denge.',
    profileRecommendedIsps: 'Çoğu fiber bağlantı',
    profileMaxName: 'Maksimum',
    profileMaxDesc: 'Agresif DPI için en güçlü bypass; CPU artabilir.',
    profileMaxIsps: 'Sert DPI: Kablonet, Superonline, Türk Telekom, Vodafone, Millenicom',
    ...
    aboutVersion: 'Sürüm',
    aboutLicense: 'Lisans',
    aboutLicenseValue: 'MIT — Açık Kaynak',
    ...
    licenseTitle: 'Lisans Anahtarı',
    licenseDesc: 'DPIReaper\'ı kullanmak için size verilen lisans anahtarını aşağıya yapıştırın.',
    licensePlaceholder: 'dpir-XXXXXX...',
    licenseActivate: 'ETKİNLEŞTİR',
    licenseFromFile: 'Dosyadan Seç',
    licenseFileError: 'Dosya okunamadı veya geçerli anahtar bulunamadı',
    licenseExpiringTitle: 'Lisans süreniz yakında bitecek',
    licenseExpiringBtn: 'Yeni anahtar al',
    licenseExpiredTitle: 'Lisans Süreniz Doldu',
    licenseExpiredDesc: 'DPIReaper kullanmaya devam etmek için yeni bir lisans anahtarı girin.',
    licenseChangeBtn: 'Yeni Lisans Gir',
    licenseQuitBtn: 'Çıkış',
    licenseValidUntil: 'Geçerlilik',
    licenseHolder: 'Lisans sahibi',
    licenseInvalid: 'Lisans geçersiz veya bozuk',
    licenseExpiredShort: 'Süresi dolmuş',
    licenseChecking: 'Doğrulanıyor...',
    licenseRemainingDays: (n) => `${n} gün kaldı`,
    licenseRemainingHours: (n) => `${n} saat kaldı`,
    licenseRemainingMinutes: (n) => `${n} dakika kaldı`,
    licenseRemainingSeconds: (n) => `${n} saniye kaldı`,
  ...
  en: {
    ...
    logStrongNoDriver: '⚠️ Strong Mode: No driver, using selected chunk size.',
    logStrongChunkOnly: '🛡️ Strong Mode: Chunk splitting active.',
    logLowCpuMode: '🟢 Low CPU mode: fake packets off, chunk ≥8 bytes.',
    logLowCpuChunkBump: (from, to) =>
    ...
    lowCpuModeTitle: 'Low CPU (Defender friendly)',
    lowCpuModeDesc: 'Windows Defender network inspection scans each tiny TLS fragment. Chunk ≥8 and no fake packets lowers CPU; very strict ISPs may need stronger settings.',
    defenderExclusionBtn: 'Add Defender exclusions',
    defenderExclusionOk: 'Defender exclusions added. Try your browser again.',
    defenderExclusionFail: 'Could not add exclusions. Run as administrator or use Windows Security → Exclusions.',
    defenderExclusionNeedAdmin: 'Administrator rights required.',
    ...
    noticeDesc: 'Windows Defender “Network Inspection” scans each TLS fragment; 1-byte chunk mode can push CPU to 90%+. Fix: enable Low CPU mode, use chunk 8+, or add Defender exclusions. False positives are harmless; Kaspersky/ESET HTTPS scanning causes similar load.',
    ...
    sectionAdvancedBypass: 'ADVANCED BYPASS',
    advancedHint: 'These settings are for advanced users. Defaults work for most cases.',
    profileFastName: 'Fast',
    profileFastDesc: 'Lightest bypass, highest speed.',
    profileFastIsps: 'Soft DPI: Turknet, small local ISPs',
    profileRecommendedName: 'Recommended',
    profileRecommendedDesc: 'Best balance for most users.',
    profileRecommendedIsps: 'Most fiber connections',
    profileMaxName: 'Maximum',
    profileMaxDesc: 'Strongest bypass for aggressive DPI; CPU may increase.',
    profileMaxIsps: 'Hard DPI: Kablonet, Superonline, Turk Telekom, Vodafone, Millenicom',
    ...
    aboutLicenseValue: 'MIT — Open Source',
    ...
    licenseDesc: 'Paste the license key you were provided to use DPIReaper.',
    licensePlaceholder: 'dpir-XXXXXX...',
    licenseActivate: 'ACTIVATE',
    licenseFromFile: 'Pick a file',
    licenseFileError: 'Could not read file or find valid key',
    licenseExpiringTitle: 'Your license expires soon',
    licenseExpiringBtn: 'Get new key',
    licenseExpiredTitle: 'Your License Expired',
    licenseExpiredDesc: 'Enter a new license key to continue using DPIReaper.',
    licenseChangeBtn: 'Enter New License',
    licenseQuitBtn: 'Quit',
    licenseValidUntil: 'Valid until',
    licenseHolder: 'Licensee',
    licenseInvalid: 'License is invalid or corrupted',
    licenseExpiredShort: 'Expired',
    licenseChecking: 'Verifying...',
    licenseRemainingDays: (n) => `${n} days left`,
    licenseRemainingHours: (n) => `${n} hours left`,
    licenseRemainingMinutes: (n) => `${n} minutes left`,
    licenseRemainingSeconds: (n) => `${n} seconds left`,
